...
\centering
\ndsuincludegraphics[
    width=0.7\linewidth, keepaspectratio
]
{The graph shows the elevation of two parameters and it has a person standing right next to it}
{figures/Graph1.jpg}
\caption{\LaTeX{} template graph with some demo bar charts}
\label{fig:Graph1.jpg}
\end{figure}
\begin{figure}[htbp]
\centering
\ndsuincludegraphics[
...
{THe graph shows the elevation of two parameters and it has a person standing right next to it}
{figures/Graph1.jpg}
\caption{Graph showing another demo figure for the template.}
\label{fig:Graph1.jpg}
\end{figure}
